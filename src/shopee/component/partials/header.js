    ...
    <header className="header">
      <div className="grid wide">
        <nav className="header__navbar hide-on-mobile-tablet">
          <ul className="header__navbar-list">
            <li className="header__navbar-item header__navbar-item--has-qr header__navbar-item--separate">
              ...
              <div className="header-qr">
                <img src={qr} alt="QR code" className="header-qr__img"/>
                <div className="header__qr-apps">
                  <div className="header__qr-link">
                    <img src={gg} alt="Google Play" className="header-qr-download-img"/>
                  </div>
                  <div className="header__qr-link">
                    <img src={appstore} alt="App Store" className="header-qr-download-img"/>
                  </div>
                </div>
              </div>
            </li>
          ...
          <ul className="header__navbar-list">
            <li className="header__navbar-item header__navbar-item-has-notify">
              <div className="header__navbar-item-link"><i className="header__navbar-icon far fa-bell"></i>
                Thông báo
              </div>
              <div className="header__notify">
                ...
                <ul className="header__notify-list">
                  <li className="header__notify-item header__notify-item--viewed">
                    <div className="header__notify-link">
                      <span><img src="../../assets/img/anh/4.jpg" alt="" className="header__notify-img"/></span>
                  ...
                  <li className="header__notify-item header__notify-item--viewed">
                    <div className="header__notify-link">
                      <span><img src="../../assets/img/anh/2.jpg" alt="" className="header__notify-img"/></span>
                      <div className="header__notify-info">
                        <span className="header__notify-name">Sale sốc bộ dưỡng Ohui The First Tái tạo trẻ hoá da SALE OFF 70%</span>
                        <span
                          className="header__notify-description">Giá chỉ còn 375.000 (giá gốc : 1.200.000 vnđ)</span>
                      </div>
                    </div>
                  </li>
                  ...
                  <li className="header__notify-item header__notify-item--viewed">
                    <div className="header__notify-link">
                      <span><img src="../../assets/img/anh/3.jpg" alt="" className="header__notify-img"/></span>
                      <div className="header__notify-info">
                ...
                <footer className="header__notify-footer">
                  <div className="header__notify-footer-btn">Xem tất cả</div>
                </footer>
              </div>
            </li>
            <li className="header__navbar-item">
              <div className="header__navbar-item-link"><i className="header__navbar-icon far fa-question-circle"></i>Trợ
                giúp
              </div>
            </li>
            ...
            {currentUser === null &&
              <NavLink to="/login">
                <div className="header__navbar-item header__navbar-item--strong header__navbar-item-login">Đăng Nhập
                </div>
              </NavLink>
            }
            {currentUser !== null &&
              <div
                onMouseOver={() => {
                  document.querySelector('.header__navbar-user-menu').style.display = 'block'
                }}
                onMouseLeave={() => {
                  document.querySelector('.header__navbar-user-menu').style.display = 'none'
                }}
              ...
              >
                ...
                <ul className="header__navbar-user-menu">
                  ...
                  <li className="header__navbar-user-menu-item header__navbar-user-menu-item--separate">
                    {/* <div>Đăng xuất</div> */}
                    {currentUser !== null &&
                      <div className="user header__navbar-item header__navbar-item--strong header__navbar-item-login"
                           key="logout" onClick={() => logoutShopee()}>
                        Đăng xuất
                      </div>
                    }
                  </li>
            ...
            {/* <li className="header__navbar-item header__navbar-user">
                        <img src="../../assets/img/anh/6.jpg" alt="" className="header__navbar-user-img"/>
        ...
        <div className="header-with-search">
          ...
          <div htmlFor="nav-mobile-input" className="nav__bars-btn">
            <i className="fas fa-bars"></i>
          </div>
          <input type="checkbox" hidden className="nav__input" id="nav-mobile-input"/>
          <nav className="nav__mobile">
            <div htmlFor="nav-mobile-input" className="nav__mobile-close">
              <i className="fas fa-times"></i>
            </div>
            <ul className="nav__mobile-list">
              <li>
                <div className="nav__mobile-link">Home</div>
              </li>
              <li>
                <div className="nav__mobile-link">About</div>
              </li>
              <li>
                <div className="nav__mobile-link">Category</div>
              </li>
              <li>
                <div className="nav__mobile-link">News</div>
              </li>
              <li>
                <div className="nav__mobile-link">Contact</div>
              </li>
            </ul>
          </nav>

          <div htmlFor="mobile-search-checkbox" className="header__mobile-search">
            <i className="header__mobile-search-icon fas fa-search"></i>
          </div>
          <input type="checkbox" hidden className="header__mobile-search" id="mobile-search-checkbox"/>

          <div style={{cursor: 'pointer'}} onClick={() => toHome()} className="header__logo hide-on-tablet">
          ...
          <div className="header__search">
            ...
            <div className="header__search-selection">
                        <span className="header__search-selection-div">
                            Tìm trong Shop
                        </span>
              {/* <i className="header__search-selection-icon fas fa-chevron-down"></i>
          ...
          <div className="header__cart" onClick={() => toCart()}>
            <div className="header__cart-wrap">
              ...
              <span className="header__cart-notice">{count}</span>
            </div>
          </div>
        </div>
      </div>
      <ul className="header__sort-bar">
        <li className="header__sort-item">
          <div className="header__sort-link">Liên quan</div>
        </li>
        <li className="header__sort-item">
          <div className="header__sort-link">Mới nhất</div>
        </li>
        <li className="header__sort-item">
          <div className="header__sort-link">Bán chạy</div>
        </li>
        <li className="header__sort-item">
          <div className="header__sort-link">Giá</div>
        </li>
      </ul>
    </header>
  )
...
export default React.memo(HeaderShopee)
