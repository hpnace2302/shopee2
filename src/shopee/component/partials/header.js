        ...
        <div className="grid wide">
            <nav className="header__navbar hide-on-mobile-tablet">
                ...
                <ul className="header__navbar-list">
                    ...
                    <li className="header__navbar-item">
                        <div className="header__navbar-item-link"><i className="header__navbar-icon far fa-question-circle"></i>Trợ giúp</div>
                    </li>
                    ...
                    { infoUser === null &&
                      <NavLink to="/login">
                        <div className="header__navbar-item header__navbar-item--strong header__navbar-item-login">Đăng Nhập</div>
                      </NavLink>
                    }
                    {infoUser !== null &&
                    <div
                    ...
                    >
                      ...
                      <ul className="header__navbar-user-menu">
                        ...
                        <li className="header__navbar-user-menu-item header__navbar-user-menu-item--separate">
                            {/* <div>Đăng xuất</div> */}
                          {infoUser !== null && 
                          <div className="user header__navbar-item header__navbar-item--strong header__navbar-item-login" key="logout" onClick={() => logoutShopee()}>
                            Đăng xuất
                          </div>
                          }
                        </li>
